...
這反而讓我們更應該把 README 寫好，因為 Git 已經替你解決「最終版の無限增殖」了——**不用再 `最終版2`，commit 本身就是歷史版本。**

既然現在 README 還是 Astro 原廠包裝紙，那就可以直接整份換掉。

## `README.md`

下面這坨可以**整份複製，覆蓋目前 README**：
